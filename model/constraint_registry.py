...
def hc_nurse_absence(
    ...
    Parametri:
    - absences: lista di assenze nel formato:
      [
        {
          "nurse_name": "Nome Infermiere",
          "start_day": 5,  # giorno di inizio assenza (0-based)
          "end_day": 7,    # giorno di fine assenza (0-based, incluso)
          "reason": "Formazione/Vacanza"  # opzionale
        }
      ]
    """
...
def hc_predefined_shifts(
    ...
    Parametri:
    - predefined: lista di turni predefiniti nel formato:
      [
        {
          "nurse_name": "Nome Infermiere",
          "day": 5,  # giorno specifico (0-based)
          "shift_type": "MORNING",  # MORNING, AFTERNOON, NIGHT, SMONTO
          "reason": "Esigenza specifica"  # opzionale
        }
      ]
    """
    ...
    for predef in predefined:
        ...
        # Impedisce altri turni nello stesso giorno (un infermiere può avere solo un turno per giorno)
